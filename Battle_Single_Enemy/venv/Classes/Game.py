...
class Person:
    ...
    def Get_Enemy_Stats(self):
        Hp_Bar = ""
        Mp_Bar = ""
        Hp_ticks = (self.Hp / self.MaxHp) * 75
        Mp_ticks = (self.Mp / self.MaxMp) * 30
        ...
        print("                                ___________________________________________________________________________                 ______________________________")
